...
while not pyray.window_should_close():
    ...
    pyray.draw_circle_lines(screenWidth // 5, 340, 80, pyray.BLACK)

    pyray.draw_ellipse(screenWidth // 5, 120, 25, 20, pyray.YELLOW)
    pyray.draw_ellipse_lines(screenWidth // 5, 120, 30, 25, pyray.YELLOW);
    ...
    #pyray.draw_circle(screenWidth // 4 * 3, 330, 80, pyray.DARKBLUE)

    pyray.draw_poly(pyray.Vector2(screenWidth / 4.0 * 3, 330), 20, 80, rotation, pyray.BROWN)
    #pyray.draw_poly_lines(pyray.Vector2(screenWidth / 4.0 * 3, 330), 8, 90, rotation, pyray.BROWN)
